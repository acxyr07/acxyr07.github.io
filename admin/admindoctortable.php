<?php
	...
	$result=mysqli_query($conn, $doctortable);
?>
<html>
<head>
	...
	<div class="headerwhite">
		...
		<br><br><br>
		 ...
		 <div>
		 		...
		 		<center>
					<button class="Addadmin" onclick="parent.location='adminaddDoctor.php'">Add Doctor</button>
				</center>
					<br><br>
		 	<div>
		 		<table class="aamtbl2">
		 		...
		 		?>
		 			...
		 			<tr>
		 				...
		 				<td data-label="First Name"><?php echo $rows['d_firstname']; ?></td>
		 				<td  data-label="Middle Name"><?php echo $rows['d_midname']; ?></td>
		 				<td data-label="Last Name"><?php echo $rows['d_lastname']; ?></td>
		 				<td data-label="Contact #"><?php echo $rows['d_phone']; ?></td>
		 				<td data-label="Email"><?php echo $rows['d_email']; ?></td>
		 				<td data-label="Address"><?php echo $rows['d_address']; ?></td>
