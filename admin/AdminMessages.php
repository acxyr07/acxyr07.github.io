	...
	<br><br><br>
		 ...
		 <div class="main">
		 		<div class="notdiv">
		 			<table class="aamtbl">
		 				<thead>
		 					<th class="header" style="border: 1px solid black; width: 200px;">
		 						Email from
		 					</th>
		 					<th class="header" style="border: 1px solid black; width: 250px;">
		 						Subject
		 					</th>
		 					<th class="header" style="border: 1px solid black; width: 400px;">
		 						Message
		 					</th>
		 					<th class="header" style="border: 1px solid black; width: 255px" >
		 						Date and Time
		 					</th>
		 					<th class="header" style="border: 1px solid black; width: 200px;">
		 						Action
		 				...
		 				<tr>
		 					...
		 					<td class="messagebuttons">
		 						<center>
		 							<button class="dm"><img class="tableicons" src="../icons/delete.png"></button>
		 							<button class="mar"><img class="tableicons" src="../icons/mar.png"></button>
		 						</center>
		 					</td>
		 				</tr>
		 				</tbody>
